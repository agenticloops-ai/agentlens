...
class RequestRepository:
    ...
    def _row_to_model(row: Any) -> LLMRequest:
        ...
        return LLMRequest(
            ...
            capture_label=m["capture_label"],
            capture_metadata=json.loads(m["capture_metadata"]),
    ...
    def _model_to_values(request: LLMRequest) -> dict[str, Any]:
        return {
            ...
            "capture_label": request.capture_label,
            "capture_metadata": json.dumps(request.capture_metadata),
...
class RawCaptureRepository:
    ...
    def _model_to_values(capture: RawCapture) -> dict[str, Any]:
        return {
            ...
            "capture_metadata": json.dumps(capture.capture_metadata),
